        ...
        <div>
          ...
          <form>
            ...
            <input type="number" id="account-number" name="account-number"
                   value={accountNumber} onInput={(e) => setAccountNumber(e.target.value)} />
            <br/>
            <label htmlFor="account-pin">Account Pin:</label>
            <input type="number" id="account-pin" name="account-pin" value={accountPin} onInput={(e) => setAccountPin(e.target.value)}/>
            <br/>
